        ...
        <div class="content">
            ...
            <div style="width:40%;padding-left:122px;position:relative">
                <div style="position:absolute;bottom:102px;">
                    <span style="font-size:32px">Forgot your password?</span>
                    <label style="margin-top:48px">Recovary code</label>
                    <input type="number" name="password" placeholder="Recovary code">
                    <button class="btn btn-black" style="width:390px;font-size:16px;margin-bottom:24px"><strong>LOGIN</strong></button>
                    <span id="reg-text"><strong style="color:black">Cancel</strong></span>
                </div>
            </div>
        </div>
